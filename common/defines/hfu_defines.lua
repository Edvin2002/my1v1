...
NDefines.NTechnology.BASE_TECH_COST = 500

--generals
NDefines.NMilitary.UNIT_LEADER_ASSIGN_TRAIT_COST = 200
...
NDefines.NMilitary.ARMY_FUEL_COST_MULT = 0 --0.5
NDefines.NAir.FUEL_COST_MULT = 0.14 --0.35
NDefines.NNavy.FUEL_COST_MULT = 0.04 --0.1
NDefines.NCountry.BASE_FUEL_GAIN = 120		--was 30 before					-- base amount of fuel gained hourly, independent of excess oil
...
NDefines.NMilitary.RIVER_CROSSING_PENALTY = -0.1
